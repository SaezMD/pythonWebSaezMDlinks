...
from linkBio.scriptsPersonal.randomLogo import randomLogo, listAllFiles

def footer() -> rx.Component:
    return rx.vstack(           
        rx.image(
            src="logos/logo.jfif",
            #src= "logos/" + randomLogo(listAllFiles(r"D:\Python\practicas\pythonWeb\linkBio\assets\logos")), 
